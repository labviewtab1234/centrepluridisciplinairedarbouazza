...
const teamMembers = [
  ...
  },
  {
    ...
    role: 'Orthophoniste spécialisée en troubles du langage oral et écrit chez l’adulte ',
    roleAr: 'مختصة تقويم النطق',
    roleFr: 'Orthophoniste ',
    specialties: ['Aphasies post-AVC','Dysarthrie','Maladie neuro cognitives','Troubles de la voix'],
    specialtiesAr: ['العلاج والمرافقة','التعامل مع اضطرابات اللغة الشفهية والمكتوبة'],
    specialtiesFr:  ['Aphasies post-AVC','Dysarthrie','Maladie neuro cognitives','Troubles de la voix'],
    experience: '+5 ans',
    experienceAr: '+5 سنوات خبرة',
    experienceFr: '+5 ans',
